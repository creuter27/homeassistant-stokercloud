...
async def async_setup_entry(hass, config, async_add_entities):
    ...
    async_add_entities([
        ...
        StokerCloudControllerSensor(client, serial, 'Online Time Percent', 'time_online_percent',
                                    SensorDeviceClass.PERCENT),
        StokerCloudControllerSensor(client, serial, 'Windspeed', 'wind_speed', SensorDeviceClass.SPEED),
        StokerCloudControllerSensor(client, serial, 'Windspeed', 'wind_direction'),
        ...
        StokerCloudControllerSensor(client, serial, 'Output Percentage', 'output_percentage',
                                    SensorDeviceClass.PERCENT),
        StokerCloudControllerSensor(client, serial, 'Photosensor Power', 'boiler_photosensor',
                                    SensorDeviceClass.PERCENT),      
        StokerCloudControllerSensor(client, serial, 'Boiler Power', 'boiler_power', SensorDeviceClass.POWER),
        StokerCloudControllerSensor(client, serial, 'Boiler Power 10 Percent', 'power_10_percent', SensorDeviceClass.POWER),
        StokerCloudControllerSensor(client, serial, 'Boiler Power 100 Percent', 'power_100_percent', SensorDeviceClass.POWER),
        ...
        StokerCloudControllerSensor(client, serial, 'Exhaust Fan', 'ashauger'),
